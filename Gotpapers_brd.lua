...
function init_gear_sets()
  ...
  sets.precast.WS['Rudra\'s Storm'] = set_combine(sets.precast.WS, {
    range={ name="Linos", augments={'Accuracy+15','"Store TP"+3','Quadruple Attack +2',}},
    head={ name="Lustratio Cap", augments={'Attack+15','STR+5','"Dbl.Atk."+2',}},
    body={ name="Bihu Jstcorps. +3", augments={'Enhances "Troubadour" effect',}},
    hands={ name="Lustratio Mittens", augments={'Accuracy+25','VIT+10','DEX+7',}},
  ...
  -- sets.midcast.SongEnfeebleAcc = set_combine(sets.midcast.SongEnfeeble, {legs="Brioso Cannions +3"}) TODO
  ...
  sets.engaged = {
    -- main={ name="Skinflayer", augments={'"Triple Atk."+2','DEX+3','Accuracy+18','Attack+6','DMG:+14',}},
